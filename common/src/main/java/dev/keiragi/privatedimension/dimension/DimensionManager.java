...
public class DimensionManager {
    ...
    public static final ResourceLocation DIMENSION_ID =
        ResourceLocation.parse(PrivateDimensionMod.MOD_ID + ":" + "private_dimension");
    ...
    public void placeStructure(ServerLevel level, BlockPos origin) {
        try {
            ...
            ResourceLocation structId = ResourceLocation.parse(PrivateDimensionMod.MOD_ID + ":" + "plot48x48");
